...
String username = (ListUsername_split[UserLogin]).trim()
...
String password = (ListPassword_split[UserLogin]).trim()
...
WebUI.verifyElementNotPresent(findTestObject('Page_Swag Labs/Login/Failed Login Popup'), 3)
